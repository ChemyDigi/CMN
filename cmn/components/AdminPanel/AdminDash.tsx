...
import { FaTools, FaSnowflake, FaUsers, FaBox, FaShoppingCart, FaChartLine, FaSync, FaEye } from "react-icons/fa";
    ...
    <div className="w-full space-y-4 md:space-y-6 px-3 md:px-0">
        ...
        <div className="bg-[#d9d9d9] p-4 md:p-6 rounded-xl shadow-lg text-black">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl md:text-3xl font-bold">{stats.activeProducts}</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-4 md:p-6 rounded-xl shadow-lg">
          <h2 className="text-lg font-semibold mb-3 md:mb-4 text-black">Quick Actions</h2>
          <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 md:gap-4">
            <Link href="/admin/add-products/tools" className="p-3 md:p-4 border rounded-lg hover:bg-pink-50 transition-colors">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-blue-100 rounded-lg">
                  <FaTools className="text-blue-500" />
                </div>
                <div>
                  <p className="font-medium text-sm md:text-base text-black">Add Tool</p>
                  <p className="text-xs text-gray-500 hidden xs:block">Create new tool</p>
                </div>
              </div>
            </Link>

            <Link href="/admin/add-products/ref-ac" className="p-3 md:p-4 border rounded-lg hover:bg-pink-50 transition-colors">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-teal-100 rounded-lg">
                  <FaSnowflake className="text-teal-500" />
                </div>
                <div>
                  <p className="font-medium text-sm md:text-base text-black">Add AC / Refrigerator</p>
                  <p className="text-xs text-gray-500 hidden xs:block">Create new appliance</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sm md:text-base text-black">Manage Products</p>
      ...
      {lowStockProducts.length > 0 && (
        <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg">
          <div className="flex items-center gap-2 mb-3 md:mb-4">
            ...
            <h2 className="text-lg font-semibold text-red-600">Low Stock / Discontinued</h2>
