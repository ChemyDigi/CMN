...
const ReviewSection: React.FC<ReviewSectionProps> = ({ productId, reviews = [] }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const productRef = doc(db, "AC&Ref", productId);
  ...
  return (
    <div className="w-full bg-white border-t border-gray-400 mt-10 sm:mt-16 md:mt-20 pt-6 sm:pt-8 md:pt-10 pb-10 sm:pb-14 md:pb-16 px-4 xs:px-5 sm:px-6 md:px-8 lg:px-12 xl:px-20">
      {/* Reviews Section */}
              ...
              <div className="flex items-start gap-2 sm:gap-3 md:gap-3 mb-1.5 sm:mb-2">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                    ...
                    <span className="text-pink-500 text-sm sm:text-base md:text-lg">
