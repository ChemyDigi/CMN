...
import heroImageMobile from "../../public/images/hero/heroAC-mobile.webp";
import heroImageDesktop from "../../public/images/hero/heroAC.webp";
    ...
    <section className="relative w-full min-h-screen flex items-center overflow-hidden pt-20">
      ...
      >
        ...
        <div className="absolute inset-0 block md:hidden">
          <Image
            src={heroImageMobile}
            alt="Refrigerators & Air Conditioners - Mobile"
            fill
        ...
        <div className="absolute inset-0 hidden md:block">
          <Image
            ...
            alt="Refrigerators & Air Conditioners - Desktop"
            fill
            className="object-cover brightness-50"
            priority
            sizes="100vw"
