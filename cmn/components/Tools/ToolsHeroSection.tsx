...
import heroImageMobile from "../../public/images/hero/toolsHero-mobile.webp";
import heroImageDesktop from "../../public/images/hero/toolsHero.webp";
    ...
    <section className="relative w-full min-h-screen flex items-center overflow-hidden pt-20">
      ...
      >
        ...
        <div className="absolute inset-0 block md:hidden">
          <Image
            src={heroImageMobile}
            alt="Tools and Equipment - Mobile"
            fill
        ...
        <div className="absolute inset-0 hidden md:block">
          <Image
            ...
            alt="Tools and Equipment - Desktop"
            fill
            className="object-cover brightness-50"
            priority
            sizes="100vw"
