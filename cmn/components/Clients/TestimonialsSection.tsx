  ...
  return (
    <div style={{ backgroundColor: '#f4f4f4' }} className="py-10 sm:py-14 md:py-16 lg:py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        {/* Three Cards Section - Centered on all screen sizes */}
        <div 
          ref={cardsRef}
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mx-auto justify-center max-w-6xl"
        >
          {/* First Card - Centered */}
          <div className={`bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-4 sm:p-6 md:p-8 shadow-sm hover:shadow-lg transition-all duration-500 ease-out transform hover:-translate-y-1 text-center ${
            isCardsInView 
              ? 'opacity-100 translate-y-0' 
              : 'opacity-0 translate-y-10'
          }`}>
            ...
            <div className="mb-3 sm:mb-4 md:mb-6">
              <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 lg:w-10 lg:h-10 text-gray-300 mb-2 sm:mb-3 mx-auto" fill="currentColor" viewBox="0 0 32 32">
                <path d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z"/>
              </svg>
              <p className="text-gray-700 mb-0 leading-relaxed text-xs sm:text-sm md:text-base lg:text-lg text-center">
                "{testimonials[0].content}"
              </p>
            </div>
            
            <div className="text-center border-t border-gray-100 pt-3 sm:pt-4 md:pt-6">
          ...
          <div className={`bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-4 sm:p-6 md:p-8 shadow-sm hover:shadow-lg transition-all duration-500 ease-out transform hover:-translate-y-1 text-center delay-100 ${
            isCardsInView 
              ? 'opacity-100 translate-y-0' 
              : 'opacity-0 translate-y-10'
          }`}>
          ...
          {/* Third Card - Centered */}
          <div className={`bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-4 sm:p-6 md:p-8 shadow-sm hover:shadow-lg transition-all duration-500 ease-out transform hover:-translate-y-1 text-center delay-200 ${
            isCardsInView 
              ? 'opacity-100 translate-y-0' 
              : 'opacity-0 translate-y-10'
          }`}>
